            ...
            <div class="jumbotron p-3 mb-3" style="display: flex;justify-content: center;border-radius: 50px;margin: 0 auto;">
                <div class="user-info">
                    ...
                    <ul class="meta list list-unstyled" style="text-align:center;">
                        ...
                        <li class="my-2"><a href="logout.php"><button class="btn btn-secondary" style="font-size: 15px;padding: 3px 8px;">Logout</button></a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <form action="partials/_manageProfile.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group  col-md-6">
                                ...
                                <input class="form-control" id="password" name="password" placeholder="Enter Password" type="password" data-toggle="password" >
